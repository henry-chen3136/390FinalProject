...
leo_jumping = np.loadtxt(open("C:/Users/Cassie G/Documents/390FinalProject-1/AllJumpingLeo.csv"), delimiter=",", skiprows=1)
leo_walking = np.loadtxt(open("C:/Users/Cassie G/Documents/390FinalProject-1/AllWalkingLeo.csv"), delimiter=",", skiprows=1)

henry_jumping = np.loadtxt(open("C:/Users/Cassie G/Documents/390FinalProject-1/_______.csv"), delimiter=",", skiprows=1)
henry_walking = np.loadtxt(open("C:/Users/Cassie G/Documents/390FinalProject-1/_______.csv"), delimiter=",", skiprows=1)
